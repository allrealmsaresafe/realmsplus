...
module.exports = {
    ...
    if (!userData) {
      newUser = await userDB.create({userID: guild.ownerId,botBan: false,gamertag: '0',addCount: 0, basicPlan: false,arasPlan: false,arasPlusPlan: false,reportCount: 0,isAdmin: false});newUser.save().catch()
